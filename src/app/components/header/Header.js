/**
 * Created by ChhaiChivon on 3/17/2017.
 */
                                    ...
                                    <div className="container">
                                        <div className="row row1">
                                            <ul className="largenav pull-right">
                                                <li className="upper-links"><a className="links" href="http://clashhacks.in/"><i className="fa fa-home" aria-hidden="true"></i>&nbsp;Home</a></li>
                                                <li className="upper-links"><a className="links" href="https://campusbox.org/"><i className="fa fa-user" aria-hidden="true"></i>&nbsp;Login</a></li>
                                                <li className="upper-links"><a className="links" href="http://clashhacks.in/"><i className="fa fa-sign-in" aria-hidden="true"></i>&nbsp;Register</a></li>
                                                <li className="upper-links"><a className="links" href="http://clashhacks.in/"><i className="fa fa-lightbulb-o" aria-hidden="true"></i>&nbsp;Help</a></li>
                                        ...
                                        <div className="row row2">
                                            <div className="col-sm-2">
                                                <h2 style={{margin:'0px'}}><span className="smallnav menu">☰ Brand</span></h2>
                                                <h1 style={{margin:'0px'}}>
                                                    <span className="largenav">
                                                        <img src="/images/logo/cambo-smart.png" />
                                                    </span>
                                                </h1>
                                            </div>
